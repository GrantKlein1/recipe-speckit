| Feature | Description |
| --- | --- |
| [1 — User Authentication & Session Management](./feature-1-account-management.md) | Register, sign in, persist session, sign out, and gate private screens. Guests can view published recipes without signing in. |
| [2 — Ingredients Management](./feature-2-ingredients-management.md) | User can create/edit individual ingredients out of the list. Can choose the name, unit and price per unit. |
